...
public class ProjectArrayRepository implements IProjectRepository{
    ...
    public ProjectArrayRepository() {
        if (projects == null) {
            ...
            projects.add(new Project(Long.valueOf(1), "Sistema de Gestión de Inventarios", 
        ...
        projects.add(new Project(Long.valueOf(2), "Plataforma de E-learning", 
        ...
        projects.add(new Project(Long.valueOf(3), "Aplicación de Reservas de Restaurantes", 
        ...
        projects.add(new Project(Long.valueOf(4), "Sistema de Gestión de Recursos Humanos", 
        ...
        projects.add(new Project(Long.valueOf(5), "Plataforma de Comercio Electrónico", 
        ...
        projects.add(new Project(Long.valueOf(6), "Aplicación de Gestión de Tareas", 
        ...
        projects.add(new Project(Long.valueOf(7), "Sistema de Gestión de Biblioteca", 
        ...
        projects.add(new Project(Long.valueOf(8), "Plataforma de Gestión de Eventos", 
        ...
        projects.add(new Project(Long.valueOf(9), "Aplicación de Monitoreo de Salud", 
        ...
        projects.add(new Project(Long.valueOf(10), "Sistema de Gestión de Transporte", 
        ...
        projects.add(new Project(Long.valueOf(11), "Plataforma de Gestión de Contenidos", 
        ...
        projects.add(new Project(Long.valueOf(12), "Aplicación de Gestión de Finanzas", 
        ...
        projects.add(new Project(Long.valueOf(13), "Sistema de Gestión de Almacenes", 
        ...
        projects.add(new Project(Long.valueOf(14), "Plataforma de Gestión de Redes Sociales", 
        ...
        projects.add(new Project(Long.valueOf(15), "Aplicación de Gestión de Viajes", 
        ...
        projects.add(new Project(Long.valueOf(16), "Sistema de Gestión de Clientes", 
            "Gestión de relaciones con clientes", 
            "Automatizar procesos de CRM", 
            "Facilitar la gestión de clientes", 
            "12", "5000000", "2025-08-10", "En progreso", company));

        projects.add(new Project(Long.valueOf(17), "Plataforma de Gestión de Aprendizaje", 
        ...
        projects.add(new Project(Long.valueOf(18), "Aplicación de Seguridad en el Hogar", 
        ...
        projects.add(new Project(Long.valueOf(19), "Sistema de Gestión de Proyectos", 
        ...
        projects.add(new Project(Long.valueOf(20), "Plataforma de Gestión de Contratos", 
